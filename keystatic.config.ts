  ...
  collections: {
    ...
    projects: collection({
      ...
      schema: {
        ...
        authorSlugs: fields.array(fields.text({ label: 'Author Slug' }), {
          label: 'Author Slugs (must match member slugs)',
          itemLabel: (props) => props.value,
        }),
    ...
    members: collection({
      ...
      schema: {
        ...
        role: fields.text({ label: 'Role / Tagline' }),
        organization: fields.text({ label: 'Organisation / Project' }),
        guild: fields.select({
          label: 'Guild',
          options: [
            { label: 'Dev', value: 'dev' },
        ...
        telegramUsername: fields.text({ label: 'Telegram Username (without @)' }),
        ...
        ecosystemTags: fields.array(fields.text({ label: 'Tag' }), {
          label: 'Ecosystem Tags (e.g. Solana, DeFi, NFT)',
          itemLabel: (props) => props.value,
        }),
        featured: fields.checkbox({ label: 'Featured', defaultValue: false }),
      },
